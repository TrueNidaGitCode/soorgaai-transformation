...
Identify where AI can improve the workflow by looking for:
...
Describe opportunities using business language rather than technical AI terminology.
...
Recommend AI opportunities that directly address the identified business problems.
